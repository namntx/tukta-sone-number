...
class BettingMessageParserMultiStationsTest extends TestCase
{
    use RefreshDatabase;
    ...
    /**
     * Test 3d multi-stations
     */
    public function test_3d_multi_stations()
    {
        $message = "3d 80 50n";
        
        $result = $this->parser->parseMessage($message);
        
        $this->assertTrue($result['is_valid'], "3d should be valid");
        $this->assertGreaterThan(0, count($result['multiple_bets']), "Should have bets");
        ...
        // Should have 3 different stations
        $this->assertCount(3, $stations, "Should have 3 different stations");
    ...
    /**
     * Test 2dai multi-stations
     */
    public function test_2dai_multi_stations()
    {
        $message = "2dai 80 50n";
        
        $result = $this->parser->parseMessage($message);
        
        $this->assertTrue($result['is_valid'], "2dai should be valid");
        $this->assertGreaterThan(0, count($result['multiple_bets']), "Should have bets");
