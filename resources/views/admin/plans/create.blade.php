...
@section('title', 'Tạo gói mới - Keki SaaS')
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">
                    Thêm gói subscription mới vào hệ thống
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Mô tả chi tiết về gói subscription">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="features_text" 
                              ...
                              rows="5"
                              class="form-input"
                              placeholder="Truy cập đầy đủ tính năng&#10;Hỗ trợ 24/7&#10;Báo cáo chi tiết&#10;Tích hợp API">{{ old('features_text') }}</textarea>
