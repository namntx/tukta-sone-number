...
<div class="space-y-6">
    ...
    <!-- Filters -->
    <div class="bg-white shadow rounded-lg p-6">
        <form method="GET" action="{{ route('user.customers.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div>
                ...
                <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <select name="sort" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <option value="net_profit" {{ request('sort') == 'net_profit' ? 'selected' : '' }}>Lãi cao nhất</option>
                    <option value="net_profit_desc" {{ request('sort') == 'net_profit_desc' ? 'selected' : '' }}>Lỗ cao nhất</option>
                </select>
            </div>
