...
<div class="pb-4">
    ...
    <div class="px-3 py-2.5">
      <div class="flex items-center justify-between">
        <div class="flex-1 min-w-0">
          <h1 class="text-lg font-bold text-gray-900 truncate">Sửa: {{ $customer->name }}</h1>
  ...
  <form method="POST" action="{{ route('user.customers.update', $customer) }}" class="px-3 space-y-4">
    @csrf
    @method('PUT')
