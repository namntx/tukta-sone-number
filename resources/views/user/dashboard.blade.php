                    ...
                    <form id="betting-form" action="{{ route('user.betting-tickets.store') }}" method="POST">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" id="clear-btn" class="btn bg-gray-100 btn-icon">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    ...
                    <div id="preview-panel" class="hidden">
                        <div class="bg-white">
                            ...
                            <div class="border-t border-gray-200 pt-3 mt-3 hidden" id="highlighted-message-preview">
                                <div class="mb-2">
                            ...
                            <div class="border-t border-gray-200 pt-3" id="single-bet-preview">
                                <div class="grid grid-cols-2 gap-3 text-sm">
                                    <div>
                                        <span class="text-gray-500">Loại cược:</span>
                                        <p class="font-medium text-gray-900" id="preview-betting-type">-</p>
                                    </div>
                                    <div>
                                        <span class="text-gray-500">Đài:</span>
                                        <p class="font-medium text-gray-900" id="preview-station">-</p>
                                    </div>
                                    <div>
                                        <span class="text-gray-500">Số cược:</span>
                                        <p class="font-medium text-gray-900" id="preview-numbers">-</p>
                                    </div>
                                    <div>
                            ...
                            <div class="border-t border-gray-200 pt-3 hidden" id="multiple-bets-preview">
