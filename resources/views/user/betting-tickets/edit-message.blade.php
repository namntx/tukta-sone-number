...
<div class="pb-4">
  ...
  <div class="sticky top-14 z-10 bg-gray-50 border-b border-gray-200 -mx-3 px-3 py-2 mb-3">
    <div class="flex items-center justify-between">
      ...
      <a href="{{ request()->has('return_to') && request()->return_to === 'customer' ? route('user.customers.show', $bettingTicket->customer_id) : route('user.betting-tickets.index') }}" class="btn bg-gray-100 btn-sm btn-icon">
